...
typedef struct tabela_hash{
	...
	entrada_hash_t * armazenamento; /* Entradas da tabela contendo chaves e	conteudo */
  unsigned long int numeros_inseridos;
	/*void * sincronizacao; Aqui vai uma struct com todas as variaveis inicializadas para sincronizacao. Use a imaginacao. */
